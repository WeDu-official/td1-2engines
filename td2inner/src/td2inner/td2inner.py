...
try: from fractionalstd2inner import Fraction #cython
except: raise ImportError('you need to setup fractionalstd2inner via readme of it in https://github.com/WeDu-official/fractionalstd2inner')
